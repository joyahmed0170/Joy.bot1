...
name : ```Joy Developer```</br>
age : ```16```</br>
link : [facebook](https://www.facebook.com/mdjubaet.ahmed.9).</br>

## CREDITS

original file : [BotPack](https://replit.com/@YanMaglinte/BotPack?v=1) by ```YanMaglinte```</br>
modified : [JOY](https://replit.com/@xaikonayan/NAYAN-BOT?v=1) by ```Nayan Developer```
